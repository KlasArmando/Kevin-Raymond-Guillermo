...
/*media query nav bar en hover styling*/
...
/*media query images zorgt dat ze onder elkaar komen*/
.container {
    margin: 0 auto;
    max-width: 1200px;
...
/* hover zorgt ervoor dat het zichtbaar is welke knop je bent*/
.myButton:hover {
...
/*border voor de button zien welke actief is*/
.myButton:active {
position:relative;
top:1px;
}
